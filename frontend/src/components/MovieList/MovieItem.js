...
import { setUserHates, setUserLikes, addHate, addLike, removeHate, removeLike } from '../../redux/actions' 
...
const MovieItem = ({ item, ownerId, userLikes, userHates, userId, accessToken, setUserHates, setUserLikes, addHate, addLike, removeHate, removeLike, movieCounts }) => {
    ...
    return ( 
        <List.Item
            ...
            actions={[
                ...
                <Space>
                    <Button type="primary" ghost icon={<DislikeOutlined />}
                        style = {{
  ...
  export default connect(mapStateToProps, { setUserHates, setUserLikes, addLike, addHate, removeLike, removeHate })(MovieItem);
